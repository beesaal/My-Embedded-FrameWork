...
#else
/* If no STM32F4xx device macro is defined, default to STM32F411xE
  This file is located in the STM32F411RE vendor folder, so assume
  the STM32F411xE device when the project didn't define a target. */
#ifndef STM32F411xE
#define STM32F411xE
#endif
#endif
